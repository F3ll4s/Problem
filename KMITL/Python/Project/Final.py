...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.time_display = ctk.CTkLabel(self, text=self.time).grid(row=0, column=0, columnspan=2, pady=(10, 0))
    ...
    def update_time(self):
        self.nigga = datetime.datetime.now()
        current_time = self.nigga.strftime("%H:%M:%S")
        print(current_time)
        ctk.after(1000)
